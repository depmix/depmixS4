...
setMethod("logLik",signature(object="depmix"),
	...
	function(object,method="fb") { #4/5/2012: set to fb as this is now in C
		if(method=="fb") ll <- fb(object@init,object@trDens,object@dens,object@ntimes,stationary=object@stationary)$logLike
		if(method=="lystig") ll <- lystig(object@init,object@trDens,object@dens,object@ntimes,stationary=object@stationary)$logLike
